...
ALTER TABLE  `ohshit_posts` ADD  `hits` INT NOT NULL AFTER  `time`;
ALTER TABLE  `ohshit_posts` ADD  `update_time` VARCHAR( 12 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER  `time`;
